        ...
        <div className="glass border border-neutral-800/80 rounded-3xl p-8 md:p-10 shadow-2xl shadow-black/80 relative overflow-hidden">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-white hover:bg-neutral-100 text-neutral-950 font-bold py-3.5 rounded-xl transition duration-300 disabled:opacity-50 text-xs mt-4 shadow-lg shadow-white/5 active:scale-[0.99]"
            >
            ...
            <div className="relative flex py-2.5 items-center">
              ...
              <span className="flex-shrink mx-4 text-[9px] font-mono text-neutral-600 uppercase tracking-widest">or</span>
              <div className="flex-grow border-t border-neutral-900"></div>
            </div>

            <a
              href="/api/auth/github"
              className="w-full flex items-center justify-center gap-2.5 bg-neutral-950 border border-neutral-900 hover:bg-neutral-900 text-neutral-200 hover:text-white font-semibold py-3.5 rounded-xl transition duration-300 text-xs shadow-md"
            >
